                        ...
                        <div class="container overflow-hidden">
                            <div class="container-fluid d-flex align-items-center flex-row justify-content-between p-0 mb-3">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="more-dropdown">
                                    {{-- <form method="POST" action="{{ route('archive') }}">
                                        <input type="text" class="invisible d-none" value="{{ $note->note_id }}"/>
                                        <li><button type="submit" class="dropdown-item">Archive</button></li>
                                    </form>
                                    <form method="POST" action="{{ route('trash') }}">
                                        <input type="text" class="invisible d-none" value="{{ $note->note_id }}"/>
                                        <li><button type="submit" class="dropdown-item">Move to trash</button></li>
                                    </form> --}}
